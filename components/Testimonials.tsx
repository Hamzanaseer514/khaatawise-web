    ...
    <div className="w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
        {testimonials.map((testimonial, index) => (
          <div
            key={testimonial.id}
            className="bg-white dark:bg-[#16161a] rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-7 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-800 hover:border-primary dark:hover:border-accent group hover:-translate-y-1 animate-fade-in-up"
          ...
          >
            ...
            <div className="mb-3 sm:mb-4">
              <svg className="w-8 h-8 sm:w-10 sm:h-10 text-primary/20 dark:text-accent/20" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Testimonial Text */}
            <p className="text-sm sm:text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-5 sm:mb-6">
              {testimonial.text}
            </p>

            {/* User Info */}
            <div className="flex items-center gap-3 sm:gap-4 pt-4 sm:pt-5 border-t border-gray-100 dark:border-gray-800">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-primary to-primary-dark dark:from-accent dark:to-primary rounded-full flex items-center justify-center text-white text-xl sm:text-2xl font-bold shadow-lg flex-shrink-0">
                {testimonial.image}
              </div>
              <div className="flex-1 min-w-0">
                <div className="font-bold text-gray-900 dark:text-white text-base sm:text-lg mb-0.5 sm:mb-1">{testimonial.name}</div>
